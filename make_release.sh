...
COMMON_INSTALLER_FILES="dns-overlay.sh dns-overlay.bat install-yandex-dns.sh install-yandex-dns.bat dns-overlay-device.sh canbus-owner.sh canbus-owner.bat"
